...
CONFIG_PATH = "configs/logistic_cic.yaml"
...
DEFAULT_LINEAGE_MANIFEST_PATH = Path(
    "artifacts/lineage/logistic_cic_manifest.json"
)
DEFAULT_MLFLOW_MODEL_PATH = Path(
    "artifacts/models/logistic_cic_mlflow"
)
...
def validate_target_column(
    ...
    if len(target_classes) < 2:
        raise ValueError(
            "CIC logistic training requires at least two target classes. "
...
def main() -> None:
    ...
    with mlflow.start_run(run_name="logistic-cic-baseline") as run:
        ...
        lineage_input = LineageManifestInput(
            model_name="aegis_hgx_logistic_cic_baseline",
            model_version="logistic_cic_baseline_v1",
            model_type="logistic_regression",
